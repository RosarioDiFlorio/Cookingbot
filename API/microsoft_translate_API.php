...
function translate($word, $from, $to)
{
	try{
		...
		$detectMethodUrl = 'http://api.microsofttranslator.com/V2/Http.svc/Translate?text='. urlencode($word).'&from='.$from.'&to='. $to;
...
echo $input . " -> ";
translate($input,"en","it");
*/


function detectLang($inputStr)
{
	try{
		//Client ID of the application.
		$clientID       = "id_cookingbot_30";
